            ...
            <div className="mx-auto max-w-6xl px-4 sm:px-8 py-16 grid lg:grid-cols-12 gap-10 items-start">
                <div className="lg:col-span-5">
                    ...
                    <p className="mt-4 text-muted-foreground">
                        TagIT is and will always be free. But weather-proof printed stickers cost money. Sponsor a batch — we'll add a small "Sponsored by you" footer on the PDF and ship them to RTOs, pet shelters, hospitals and senior-citizen groups.
                    </p>
                    {stats && (
