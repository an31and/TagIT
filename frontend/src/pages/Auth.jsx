...
/**
 * Single screen for both /login and /signup — `mode` switches copy.
 *
 * REMINDER: DO NOT HARDCODE THE URL, OR ADD ANY FALLBACKS OR REDIRECT URLS,
 * THIS BREAKS THE AUTH.  The Google button uses window.location.origin so the
 * user lands back on the exact host they came from.
 */
            ...
            <div className="flex flex-col">
                ...
                <div className="flex-1 flex items-center justify-center p-6">
                    <form onSubmit={onSubmit} className="w-full max-w-sm space-y-5" data-testid={isSignup ? "signup-form" : "login-form"}>
                        ...
                        >
                            <GoogleIcon /> {t("auth.continue_with_google")}
                        </Button>
