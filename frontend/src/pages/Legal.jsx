            ...
            <header className="border-b">
                <div className="mx-auto max-w-3xl px-4 sm:px-8 h-14 flex items-center justify-between">
                    <Link to="/" className="font-display font-black inline-flex items-center gap-2" data-testid="legal-brand">
                        <Tag className="h-4 w-4 text-accent" /> Tag<span className="text-accent">IT</span>
                    </Link>
...
export function PrivacyPage() {
    return (
        <LegalLayout title="Privacy policy">
            <p>
                TagIT is a privacy-first, free public-service smart-tag ecosystem from India. We collect the
...
export function TermsPage() {
    return (
        <LegalLayout title="Terms of service">
            <p>
                TagIT is provided free of cost as a public service. It is offered "as is" with no warranty of any
                kind. We do our best to keep the service available and secure, but we are not liable for losses
                arising from the use, misuse or unavailability of TagIT.
            </p>
            <ul>
...
export function MedicalDisclaimerPage() {
    return (
        <LegalLayout title="Medical disclaimer">
            ...
            <p>
                The Medical Emergency Mode on TagIT shows the information you, the owner, have entered and given
            ...
            <p>
                TagIT does not provide medical advice, diagnosis or treatment. We are not responsible for actions
